...
a = np.loadtxt(open("../Raw Data Files/User 6/emotIOn_U6_D1.csv"), delimiter = ",", skiprows = 1) #Take Data from file on src path.
b = np.loadtxt(open("../Raw Data Files/User 6/emotIOn_U6_D2.csv"), delimiter = ",", skiprows = 1) #Take Data from file on src path.
