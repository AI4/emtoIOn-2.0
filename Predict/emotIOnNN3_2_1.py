...
a = np.loadtxt(open("../Raw Data Files/User 3/emotIOn_U3_D2.csv"), delimiter = ",", skiprows = 1) #Take Data from file on src path.
b = np.loadtxt(open("../Raw Data Files/User 3/emotIOn_U3_D1.csv"), delimiter = ",", skiprows = 1) #Take Data from file on src path.
