...
a = np.loadtxt(open("../Raw Data Files/User 5/emotIOn_U5_D1.csv"), delimiter = ",", skiprows = 1) #Take Data from file on src path.
b = np.loadtxt(open("../Raw Data Files/User 5/emotIOn_U5_D2.csv"), delimiter = ",", skiprows = 1) #Take Data from file on src path.
